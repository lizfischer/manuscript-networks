...
function nodeActive(a) {
    ...
    d = "";
        ...
        // If edge weight is present, sort connections by weight
        if (connections_list[0].edge_attr.hasOwnProperty("Edge Weight")){
            connections_list.sort(function(a, b){
                return b.edge_attr["Edge Weight"] - a.edge_attr["Edge Weight"];
            });
        }
